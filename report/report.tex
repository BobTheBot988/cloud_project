...
(scale-\emph{in} under an idle drain is less commonly reported; many published profiles do not include a long idle period).
...
$2{\to}1$ scale-\emph{in} under an idle drain is less commonly reported,
because many published load profiles do not include a long idle period; Test~A
