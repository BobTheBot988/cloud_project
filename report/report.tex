...
collector's 60\,s resolution). The full scale-\emph{in} back to one pod takes
a mean of $\approx$740\,s (range 352--1{,}614\,s) from the moment CPU falls
...
$6{\to}5{\to}4{\to}3{\to}2{\to}1$. Because scale-in fires \emph{mid-run}, the
...
including mid-run scale-\emph{in} with a mean latency of $\approx$740\,s, the
